...
| 11 | **Zeitraum-Selector (3M–All) nur im Overview-Scope** — Exercise-Scope (`historyForExercise`/`sessionSummariesForExercise`) und Workout-Scope (`muscleSplitForWorkout`) nutzen weiterhin ein festes "letzte N Sessions"-Limit statt eines echten Datums-Cutoffs. Bewusste Vereinfachung aus Stufe 4 Teil 2 — Umbau auf Datumsbereich wäre ein eigener, unabhängiger Aufwand. | 3 |
